#############################################################################
# Makefile for building: Pngyu.app/Contents/MacOS/Pngyu
...
COMPRESS      = gzip -9f
DISTNAME      = Pngyu1.0.0
DISTDIR = /Users/cameronbanga/Developer/git/Pngyu/.tmp/Pngyu1.0.0
...
QMAKE_TARGET  = Pngyu
DESTDIR       = 
TARGET        = Pngyu.app/Contents/MacOS/Pngyu
...
Pngyu.app/Contents/MacOS/Pngyu: ui_pngyumainwindow.h ui_pngyupreviewwindow.h ui_pngyupreferencesdialog.h ui_pngyuimageoptimintegrationquestiondialog.h $(OBJECTS)  
	@test -d Pngyu.app/Contents/MacOS/ || mkdir -p Pngyu.app/Contents/MacOS/
...
Pngyu.app/Contents/PkgInfo: 
	@test -d Pngyu.app/Contents || mkdir -p Pngyu.app/Contents
	@$(DEL_FILE) Pngyu.app/Contents/PkgInfo
	@echo "APPL????" > Pngyu.app/Contents/PkgInfo
Pngyu.app/Contents/Info.plist: 
	@test -d Pngyu.app/Contents || mkdir -p Pngyu.app/Contents
	@$(DEL_FILE) Pngyu.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - resource/info.plist | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.cameronbanga.Pngyu,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.cameronbanga.Pngyu,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,icon.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},icon.icns,g" -e "s,@EXECUTABLE@,Pngyu,g" -e "s,@LIBRARY@,Pngyu,g" -e "s,\$${EXECUTABLE_NAME},Pngyu,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Pngyu.app/Contents/Info.plist
Pngyu.app/Contents/Resources/icon.icns: resource/icon.icns
	@test -d Pngyu.app/Contents/Resources/ || mkdir -p Pngyu.app/Contents/Resources/
	@$(DEL_FILE) Pngyu.app/Contents/Resources/icon.icns
	@$(COPY_FILE) resource/icon.icns Pngyu.app/Contents/Resources/icon.icns

all: Makefile \
		Pngyu.app/Contents/PkgInfo \
		Pngyu.app/Contents/Info.plist \
		Pngyu.app/Contents/Resources/icon.icns Pngyu.app/Contents/MacOS/Pngyu
