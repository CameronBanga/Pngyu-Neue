#############################################################################
# Makefile for building: PngyuNeue.app/Contents/MacOS/PngyuNeue
# Generated by qmake (3.1) (Qt 6.9.2)
# Project:  Pngyu.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Pngyu.pro
#############################################################################
...
CXXFLAGS      = -pipe -stdlib=libc++ -std=c++17 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -mmacosx-version-min=12.0 -Wall -Wextra $(DEFINES)
INCPATH       = -I. -Ipreview_window -Ipreferences_dialog -Iimageoptim_integration_question_dialog -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PngyuNeue1.0.0
DISTDIR = /Users/cameronbanga/Developer/git/Pngyu/.tmp/PngyuNeue1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -mmacosx-version-min=12.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/opt/homebrew/lib
...
SOURCES       = main.cpp \
		...
		executecompressworkerthread.cpp qrc_resource.cpp \
		moc_pngyumainwindow.cpp \
		moc_basicimageview.cpp \
		moc_pngyupreviewwindow.cpp \
		moc_executecompressthread.cpp \
		moc_pngyupreferencesdialog.cpp \
		moc_pngyuimageoptimintegrationquestiondialog.cpp \
		moc_executecompressworkerthread.cpp
OBJECTS       = main.o \
		pngyumainwindow.o \
		...
		pngyupreferencesdialog.o \
		pngyuimageoptimintegrationquestiondialog.o \
		executecompressworkerthread.o \
		qrc_resource.o \
		moc_pngyumainwindow.o \
		moc_basicimageview.o \
		moc_pngyupreviewwindow.o \
		moc_executecompressthread.o \
		moc_pngyupreferencesdialog.o \
		moc_pngyuimageoptimintegrationquestiondialog.o \
		moc_executecompressworkerthread.o
...
QMAKE_TARGET  = PngyuNeue
DESTDIR       = 
TARGET        = PngyuNeue.app/Contents/MacOS/PngyuNeue

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/cameronbanga/Developer/git/Pngyu/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/cameronbanga/Developer/git/Pngyu/Pngyu.pro


include /opt/homebrew/Cellar/qt/6.9.2/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

PngyuNeue.app/Contents/MacOS/PngyuNeue: ui_pngyumainwindow.h ui_pngyupreviewwindow.h ui_pngyupreferencesdialog.h ui_pngyuimageoptimintegrationquestiondialog.h $(OBJECTS)  
	@test -d PngyuNeue.app/Contents/MacOS/ || mkdir -p PngyuNeue.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Pngyu.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.2/share/qt/mkspecs/common/macx.conf \
...
PngyuNeue.app/Contents/PkgInfo: 
	@test -d PngyuNeue.app/Contents || mkdir -p PngyuNeue.app/Contents
	@$(DEL_FILE) PngyuNeue.app/Contents/PkgInfo
	@echo "APPL????" > PngyuNeue.app/Contents/PkgInfo
PngyuNeue.app/Contents/Info.plist: 
	@test -d PngyuNeue.app/Contents || mkdir -p PngyuNeue.app/Contents
	@$(DEL_FILE) PngyuNeue.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - resource/info.plist | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.cameronbanga.PngyuNeue,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.cameronbanga.PngyuNeue,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,icon.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},icon.icns,g" -e "s,@EXECUTABLE@,PngyuNeue,g" -e "s,@LIBRARY@,PngyuNeue,g" -e "s,\$${EXECUTABLE_NAME},PngyuNeue,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >PngyuNeue.app/Contents/Info.plist
PngyuNeue.app/Contents/Resources/icon.icns: resource/icon.icns
	@test -d PngyuNeue.app/Contents/Resources/ || mkdir -p PngyuNeue.app/Contents/Resources/
	@$(DEL_FILE) PngyuNeue.app/Contents/Resources/icon.icns
	@$(COPY_FILE) resource/icon.icns PngyuNeue.app/Contents/Resources/icon.icns

all: Makefile \
		PngyuNeue.app/Contents/PkgInfo \
		PngyuNeue.app/Contents/Info.plist \
		PngyuNeue.app/Contents/Resources/icon.icns PngyuNeue.app/Contents/MacOS/PngyuNeue
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++ -pipe -stdlib=libc++ -std=c++17 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk -mmacosx-version-min=12.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
...
pngyumainwindow.o: pngyumainwindow.cpp pngyumainwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMainWindow \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmainwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QTableWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qtablewidget.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pngyumainwindow.o pngyumainwindow.cpp

pngyu_execute_pngquant_command.o: pngyu_execute_pngquant_command.cpp pngyu_execute_pngquant_command.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QByteArray \
		/opt/homebrew/lib/QtCore.framework/Headers/qbytearray.h \
...
basicimageview.o: preview_window/basicimageview.cpp preview_window/basicimageview.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o basicimageview.o preview_window/basicimageview.cpp

pngyupreviewwindow.o: preview_window/pngyupreviewwindow.cpp preview_window/pngyupreviewwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMainWindow \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmainwindow.h \
		pngyu_pngquant_option.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		...
		/opt/homebrew/lib/QtGui.framework/Headers/QIcon \
		/opt/homebrew/lib/QtGui.framework/Headers/qicon.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pngyupreviewwindow.o preview_window/pngyupreviewwindow.cpp

executecompressthread.o: executecompressthread.cpp executecompressthread.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QThread \
		/opt/homebrew/lib/QtCore.framework/Headers/qthread.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QByteArray \
		/opt/homebrew/lib/QtCore.framework/Headers/qbytearray.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QRegularExpression \
		/opt/homebrew/lib/QtCore.framework/Headers/qregularexpression.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o executecompressthread.o executecompressthread.cpp

pngyupreferencesdialog.o: preferences_dialog/pngyupreferencesdialog.cpp preferences_dialog/pngyupreferencesdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QAbstractButton \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qabstractbutton.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QPair \
		/opt/homebrew/lib/QtCore.framework/Headers/qpair.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pngyupreferencesdialog.o preferences_dialog/pngyupreferencesdialog.cpp

pngyuimageoptimintegrationquestiondialog.o: imageoptim_integration_question_dialog/pngyuimageoptimintegrationquestiondialog.cpp imageoptim_integration_question_dialog/pngyuimageoptimintegrationquestiondialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		ui_pngyuimageoptimintegrationquestiondialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pngyuimageoptimintegrationquestiondialog.o imageoptim_integration_question_dialog/pngyuimageoptimintegrationquestiondialog.cpp

executecompressworkerthread.o: executecompressworkerthread.cpp executecompressworkerthread.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QThread \
		/opt/homebrew/lib/QtCore.framework/Headers/qthread.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QQueue \
		/opt/homebrew/lib/QtCore.framework/Headers/qqueue.h \
...
moc_pngyumainwindow.o: moc_pngyumainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_pngyumainwindow.o moc_pngyumainwindow.cpp

moc_basicimageview.o: moc_basicimageview.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_basicimageview.o moc_basicimageview.cpp

moc_pngyupreviewwindow.o: moc_pngyupreviewwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_pngyupreviewwindow.o moc_pngyupreviewwindow.cpp

moc_executecompressthread.o: moc_executecompressthread.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_executecompressthread.o moc_executecompressthread.cpp

moc_pngyupreferencesdialog.o: moc_pngyupreferencesdialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_pngyupreferencesdialog.o moc_pngyupreferencesdialog.cpp

moc_pngyuimageoptimintegrationquestiondialog.o: moc_pngyuimageoptimintegrationquestiondialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_pngyuimageoptimintegrationquestiondialog.o moc_pngyuimageoptimintegrationquestiondialog.cpp

moc_executecompressworkerthread.o: moc_executecompressworkerthread.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_executecompressworkerthread.o moc_executecompressworkerthread.cpp
