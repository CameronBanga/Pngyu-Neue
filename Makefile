...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = NewPngyu1.0.0
DISTDIR = /Users/cameronbanga/Developer/git/Pngyu/.tmp/NewPngyu1.0.0
...
QMAKE_TARGET  = NewPngyu
DESTDIR       = 
TARGET        = NewPngyu.app/Contents/MacOS/NewPngyu
...
NewPngyu.app/Contents/MacOS/NewPngyu: ui_pngyumainwindow.h ui_pngyupreviewwindow.h ui_pngyupreferencesdialog.h ui_pngyuimageoptimintegrationquestiondialog.h $(OBJECTS)  
	@test -d NewPngyu.app/Contents/MacOS/ || mkdir -p NewPngyu.app/Contents/MacOS/
...
NewPngyu.app/Contents/PkgInfo: 
	@test -d NewPngyu.app/Contents || mkdir -p NewPngyu.app/Contents
	@$(DEL_FILE) NewPngyu.app/Contents/PkgInfo
	@echo "APPL????" > NewPngyu.app/Contents/PkgInfo
NewPngyu.app/Contents/Info.plist: 
	@test -d NewPngyu.app/Contents || mkdir -p NewPngyu.app/Contents
	@$(DEL_FILE) NewPngyu.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - resource/info.plist | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.cameronbanga.NewPngyu,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.cameronbanga.NewPngyu,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,icon.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},icon.icns,g" -e "s,@EXECUTABLE@,NewPngyu,g" -e "s,@LIBRARY@,NewPngyu,g" -e "s,\$${EXECUTABLE_NAME},NewPngyu,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >NewPngyu.app/Contents/Info.plist
NewPngyu.app/Contents/Resources/icon.icns: resource/icon.icns
	@test -d NewPngyu.app/Contents/Resources/ || mkdir -p NewPngyu.app/Contents/Resources/
	@$(DEL_FILE) NewPngyu.app/Contents/Resources/icon.icns
	@$(COPY_FILE) resource/icon.icns NewPngyu.app/Contents/Resources/icon.icns

all: Makefile \
		NewPngyu.app/Contents/PkgInfo \
		NewPngyu.app/Contents/Info.plist \
		NewPngyu.app/Contents/Resources/icon.icns NewPngyu.app/Contents/MacOS/NewPngyu
